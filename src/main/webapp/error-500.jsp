...
<head>
  ...
  <title>Server Error &mdash; Kathmandu Furniture</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .retry-btn:hover { border-color: #111827; background: #f9fafb; }
...
<body>
  <div class="error-card">
    ...
    <p class="error-desc">
      Something went wrong on our end. We&rsquo;re working to fix it.<br/>
