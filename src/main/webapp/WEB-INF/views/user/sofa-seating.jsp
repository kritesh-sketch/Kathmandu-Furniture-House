...
<jsp:include page="/WEB-INF/templates/head.jsp">
    <jsp:param name="title"          value="Sofas &amp; Seating — Kathmandu Furniture"/>
...
<div class="products-page">
    ...
    <div class="cat-header">
        <div class="cat-icon-wrap"><i class="fa-solid fa-couch"></i></div>
        <div class="cat-header-text">
            <h1 class="cat-title">Sofas &amp; Seating</h1>
            <p class="cat-subtitle">${totalCount} product${totalCount != 1 ? 's' : ''}</p>
        </div>
    </div>

    <form id="filterForm" method="get" action="${pageContext.request.contextPath}/user/sofas">
        ...
        <div class="pf-topbar">
            <div class="pf-chips">
                ...
                <c:if test="${not empty search or not empty availability or not empty minPrice or not empty maxPrice}">
                    <a href="${pageContext.request.contextPath}/user/sofas" class="pf-clear-all">Clear all</a>
                </c:if>
            </div>
            ...
            <aside class="pf-sidebar" id="pfSidebar">
                <div class="pf-sidebar-inner">
                    ...
                    <div class="pf-actions">
                        ...
                        <a href="${pageContext.request.contextPath}/user/sofas" class="pf-reset-btn">Reset</a>
                    </div>
                </div>
            </aside>
                    ...
                    <c:choose>
                            ...
                            <c:forEach var="product" items="${products}">
                                <a class="product-card" href="${pageContext.request.contextPath}/user/product-details?id=${product.id}">
                                    <div class="card-image-wrap">
                                        ...
                                        <div class="card-img-placeholder" style="display:none;"><i class="fa-solid fa-couch"></i></div>
                        ...
                        <c:otherwise>
                            <div class="products-empty">
                                ...
                                <a href="${pageContext.request.contextPath}/user/sofas" class="pf-reset-btn">Clear Filters</a>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
